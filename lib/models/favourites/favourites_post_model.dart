class ShopFavouritesPostResponse {
  bool? status;
  String? message;
  FavouriteData? data;

  ShopFavouritesPostResponse({this.status, this.message, this.data});

  ShopFavouritesPostResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
